...
class FirstMedium extends StatelessWidget {
  const FirstMedium({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(" Q . First president of india?",
        style: TextStyle(
          color: Colors.blue,
          fontSize: 24.0,
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ListTile(
          title: const Text('Sarvepalli Radhakrishnan'),
        ...
        ListTile(
          title: const Text('Dr. Rajendra Prasad'),
          leading: Radio<optionDetailValue>(
        ...
        ListTile(
          title: const Text('Varahagiri Venkata Giri'),
          leading: Radio<optionDetailValue>(
